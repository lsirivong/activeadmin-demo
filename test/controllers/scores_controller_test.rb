...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { bowler_id: @score.bowler_id, event_id: @score.event_id, total: @score.total }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { bowler_id: @score.bowler_id, event_id: @score.event_id, total: @score.total }
    assert_redirected_to score_path(assigns(:score))
  end
